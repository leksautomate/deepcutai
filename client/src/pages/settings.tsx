...
import { Key, Mic, Image, Sparkles, Plus, Trash2, Save, CheckCircle, XCircle, Loader2, ArrowLeft, Palette, Settings2, Film } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const saveApiKeysMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setApiKeys({ gemini: "", groq: "", speechify: "", freepik: "", wavespeed: "", runpod: "", pollinations: "", inworld: "" });
