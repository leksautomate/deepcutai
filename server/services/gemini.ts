...
export async function generateImagePrompt(
  ...
  const styleDescriptions: Record<string, string> = {
    ...
    illustration: "2D digital illustration, graphic novel aesthetic, matte painted textures",
    abstract: "abstract artistic visuals, creative composition, bold colors",
    historical: "romantic oil painting style, aged textures, warm golden lighting",
  };
  
  const baseStyle = styleDescriptions[imageStyle] || styleDescriptions.cinematic;
...
2. Must be well detailed and display what is in the scene
3. Uses the specified style consistently
