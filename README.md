...
1. **Install**
   ```bash
   curl -fsSL https://raw.githubusercontent.com/leksautomate/deepcutai/main/install.sh | bash
   ```
2. **Setup**
   Open `http://YOUR_IP:5000` to create your admin account.
3. **Create**
   Enter a topic (e.g., "The History of AI") and click **Generate**.
...
- **Long Text-to-Speech** - Dedicated tool for generating audio from long-form text with silence removal
